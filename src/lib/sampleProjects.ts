...
const SEEDS: SampleSeed[] = [
  {
    ...
    effort: 6,
    adjustments: { conversionRateChange: 0.3 },
    launchType: "single",
    launchMonth: 2, // August
  },
  {
    ...
    market: "australia",
    effort: 4,
    adjustments: { acceptanceRateChange: 6 },
    launchType: "single",
    launchMonth: 4, // October
  },
  {
    ...
    market: "north_america",
    effort: 5,
    adjustments: { trafficChange: 9000 },
    launchType: "iterative",
    launchMonth: 2,
    iterations: [
      { name: "Phase 1: Top 10 cities", launchMonth: 2, valuePercentage: 40 },
      { name: "Phase 2: Full city set", launchMonth: 5, valuePercentage: 60 },
    ],
  },
  {
    ...
    market: "australia",
    effort: 3,
    adjustments: { retentionRateChange: 1.2 },
    launchType: "single",
    launchMonth: 6, // December
  },
  {
  ...
  },
  {
    ...
    description:
      "Streamlined checkout and confirmation screens to reduce abandonment between a booking request and final confirmation.",
    funnel: "booking_confirmation",
    market: "australia",
    effort: 5,
    adjustments: { acceptanceRateChange: 5 },
    launchType: "single",
    launchMonth: 3, // September
  },
];
